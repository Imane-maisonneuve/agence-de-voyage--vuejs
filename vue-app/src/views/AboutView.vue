<template>
  <div class="min-h-screen border-t border-gray-100 mb-10 p-10 px-10">
    <p class="mb-3">
      ...
      <strong>moments de détente sur la plage</strong>, notre équipe sélectionne
      pour vous les meilleurs forfaits touristiques adaptés à vos envies et à
      votre budget.
    </p>
    ...
    <router-link :to="{ name: 'home' }" class="text-blue-700 hover:underline">
      Retour à l'accueil
    </router-link>
  </div>
</template>
